...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2024, Month.JULY, 10), "Evento 4", "Atracao 4");
        agendaEventos.adicionarEvento(LocalDate.of(2024, Month.JULY, 11), "Evento 5", "Atracao 5");
